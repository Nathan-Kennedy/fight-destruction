...
> Versão 3 (23/09/2026). Revisão técnica e de produção com IA. Original preservado em
...
Numa cidade contínua a blast zone precisa ser legível. Padrão provisório: percentual + 3 stocks,
blast zones fixas no mundo e recuperação disponível aos dois lutadores; a câmera não define morte.
Comparar com vida + rounds na Fase 3 se o primeiro playtest mostrar fuga excessiva ou KOs confusos.
...
- Tema visual da cidade: **em aberto**, com proposta inicial em §19.1; silhuetas fortes e
...
**Proposta de trabalho, não ranking de capacidades:** Astra integra o primeiro incremento;
Opus 5.5 faz revisão independente. Alternar implementador/revisor nos próximos módulos e escolher
